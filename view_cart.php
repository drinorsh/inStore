...
<body>
	...
	<div id="wrapper">
		...
		<div id="header">
			<!-- Begin Shell -->
			<div class="shell">
				<h1 id="logo"><a class="notext" href="#" title="INstore">INstore</a></h1>
				<div id="top-nav">
					<ul>
					   ...
					   <li><a href="products.php"> Products</a></li>
						...
						<div class="dd">
							<ul>
								...
								<li>
									 <a href="warehouse_2.php">IN Beverages</a>
									
								</li>
								
								<li>
									<a href="warehouse_3.php">IN House Staff</a>
...
<div class="viewcart">
	...
	if(isset($_SESSION["cart_session"]))
    {
		...
		echo '<spa class="midigta"><a  class="a-btn" href="INstore checkout/zaadprocess.php"><span class="a-btn-text">Proced On Zaad</span> </a></span>';
		
		echo '<span class="midigta"> <a  class="a-btn" href="INstore checkout/process.php"> <span class="a-btn-text"> Pay On INStore</span></a></span>';
		echo '</span>';
		echo '</form>'; 
