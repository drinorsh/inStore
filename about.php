		...
		<div id="main" class="shell">
			...
			<div id="content">
				...
				<div class="post">
					...
					<h2>Developer</h2>
					<img src="images/rilind.jpg" alt="Post Image" width="140" height="159" />
					<p>Rilind Imeri </p>
...
<!-- Begin Sidebar -->
   ...
   <input name="shout_message" id="shout_message" type="text" placeholder="Type Message Hit Enter" maxlength="100" /> 
					...
					</div>	<p align="center">&copy; INStore.com. Groups <a href="index.php"><i><font color="fefefe"> Welcome To <strong> INStore</strong> Online Shopping Site </font></i></a></p>
					<div class="cl">&nbsp;</div>
				</div>
				<!-- End Shell -->
			</div>
