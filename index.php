					...
					<li>
					   ...
					   <li><a href="products.php"> Products</a></li>
						...
						<div class="dd">
							<ul>
								<li>
									 <a href="warehouse_1.php">IN Food Staff</a>
...
<!-- Begin Slider -->
			...
			<div class="shell">
				<ul class="slider-items">
					...
					<li>
						...
						<div class="slide-entry">
							<h4><span>INe Fruits</span><span class="small">&amp;</span><span>Frush</span>Crops</h4>
							<a href="products.php" class="button" title="Buy now"><span>Buy now</span></a>
						</div>
					</li>
					<li>
		...
		<div id="main" class="shell">
			...
			<div id="content">
				<div class="post">
					<h2>Welcome!</h2>
					You can be confident when you're shopping online with INStore. Our Secure online shopping website encrypts your personal and financial information to ensure your order information is protected.We use industry standard 128-bit encryption. Our Secure online shopping website locks all critical information passed from you to us,
    ...
    ?>
      ...
      <!-- Begin Products Slider -->
			...
			<div class="boxes">
				...
				<div class="shell">
					<div class="box post-box">
						<h2>About INStore</h2>
						<div class="box-entry">
							<img src="images/logo.png" alt="INStore" width="160" height="80"/>
							<p>You can be confident when you're shopping online with INStore. Our Secure online shopping website encrypts your personal and financial information to ensure your order information is protected.We use industry standard 128-bit encryption. Our Secure online shopping website locks all critical information passed from you to us,
					...
					<div class="box last-box">
						...
						<ul>
							...
							<li><a href="#" title="Fizzi Drinks">Drinks</a></li>
							<li><a href="#" title="Food Stuff">Food</a></li>
						</ul>
					</div>
					<div class="cl">&nbsp;</div>
				</div>
				...
				<div class="shell">
					<div class="carts">
						<ul>
							...
							<li><a href="#" title="INstore"><img src="images/suncart.png" alt="INstore" /></a></li>
				
						</ul>
					</div>	<p>&copy; INstore.com. Groups <a href="index.php"><i><font color="fefefe"> Welcome To INstore Online Shopping Site </font></i></a></p>
					<div class="cl">&nbsp;</div>
					Copyright © 2021 INStore.com All rights reserved. The information contained in INStore.com may not be published, broadcast, rewritten, or redistributed without the prior written authority of INStore.com
				</div>
				<!-- End Shell -->
			</div>
		</div>
		...
		<div class="shout_box">
      <div class="header"> live Discussion of INstore <div class="close_btn">&nbsp;</div></div>
